...
/**
 * <p>
 * Arguments passed to functions with the form <code>key =&gt; expression</code>
 * are available via the KeyValuePair object. The following is the
 * implementation of the built-in function
 * <code>&hash(key => "value", key2 => 3, ...)</code>:
 * </p>
 * 
 * <pre>
...
public class KeyValuePair {
	...
	public KeyValuePair(final Scalar _key, final Scalar _value) {
