...
public class FileObject extends IOObject<File> {
	...
	/**
	 * opens a file and references it to this file object. the descriptor
	 * parameter is a filename
	 */
	public void open(final String descriptor, final ScriptEnvironment env) {
