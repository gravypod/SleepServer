...
public class ProxyIterator implements Iterator {
	...
	public ProxyIterator(final Iterator iter, final boolean _modifyAllow) {
	...
	public static boolean isIterator(final Scalar value) {
	...
	public Object next() {
		...
		final Object temp = realIterator.next();
