 ...
 * 
 * <p>
 * When implementing the following interface, keep in mind you are implementing
 * an interface to an array data structure.
 * </p>
 */
public interface ScalarArray extends java.io.Serializable {
	...
	/**
	 * return a view into the array, ideally one that uses the same backing
	 * store
	 */
	public ScalarArray sublist(final int start, final int end);
}
