...
/**
 * <p>
 * A loadable bridge is used to perform actions on scripts when they are loaded
 * and unloaded. Loadable bridges by themselves do not add anything to the sleep
 * language at all. In conjunction with a ScriptLoader loadable bridges make it
 * easy to process the environment of scripts as they are loaded and unloaded.
 * </p>
 * 
 * <p>
 ...
 * 
 * <p>
 * Bottom line: Loadable bridges ARE used to install other bridges into a script
 * environment. Using a loadable bridge is the easiest way to make sure actions
 * are always performed on a script as it loads. Loadable bridges in conjunction
 * with a script loader are used to perform cleanup actions when a script is
 * unloaded.
 * </p>
 * 
